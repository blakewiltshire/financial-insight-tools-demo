...
st.caption(
    "*Examine price structure, trend behaviour, and selected technical patterns.*"
)

st.write(
    "Review trend, support and resistance, consolidation, breakout, "
    "and exhaustion measures across the selected asset."
)

with st.expander("ℹ️ About Price Action & Trend Confirmation"):
